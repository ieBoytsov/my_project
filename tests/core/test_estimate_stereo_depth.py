...
from src.core.depth_estimation.estimate_stereo_depth import (
    EstimateStereoDepth,
)


def test_stereo_depth_estimation_task():
    test_image_data_path_template = (
        "/Users/i.boytsov/Projects/perception/tests/core/data/stereo_image_data/test_data_road_{}"
    )
